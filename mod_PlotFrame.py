...
class PlotFrame(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.graph = wxPlot.PlotGraphics(
            [self.speedData.marker, self.speedData.line, self.rateData.marker, self.rateData.line], "记录", "X", "Y")
        # self.graph = wxPlot.PlotGraphics([self.speedData.marker],"记录", "x",
        # "y")
